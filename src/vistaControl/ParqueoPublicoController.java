...
public class ParqueoPublicoController {
    ...
    void calcularButtonPresionado(ActionEvent event) {
    	...
    	// To modify line
    	//valorAPagarTextField.setText(valorAPagar+""); ORIGINAL
    	valorAPagarTextField.setText(CURRENCY.format((valorAPagar<0)?(-1*valorAPagar):(valorAPagar)));
    	//valorAPagarTextField.setText(CURRENCY.format(-1*valorAPagar));
    }    
}
